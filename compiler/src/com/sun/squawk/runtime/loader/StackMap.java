 ...
 *============================================================================*/
     ...
     */
    public StackMap(ClassFileInputStream in, ConstantPool pool, Method method) throws IOException, VerificationException {
        this.method  = method;
        ...
        for (int i = 0 ; i < nmaps ; i++) {
            ...
            if (address <= lastAddress) {
                throw in.verificationException("Stackmap ip addresses not in order. address="+
 ...
 *============================================================================*/
    ...
    *  Load stackmap list
    */
    private Type[] loadStackMapList(ClassFileInputStream in, ConstantPool pool, Method method) throws IOException, VerificationException {
    ...
    */
    public TypeProxy addNewType(int ip) throws IOException, VerificationException {
        TypeProxy type = (TypeProxy)internedTypes.get(ip);
        if (type == null) {
            type = TypeProxy.createForMap(null, Type.NEWOBJECT, "ip proxy "+ip);
    ...
    */
    public TypeProxy findNewType(int ip, Type proxy) throws IOException, VerificationException {
