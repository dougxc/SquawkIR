...
class GraphBuilder extends BaseFunctions implements RuntimeConstants {
    ...
    */
    static Instruction read(VirtualMachine vm, BytecodeInputStream in, Method method, int maxStack, int maxLocals, StackMap map) throws IOException, VerificationException {
    ...
    * Build the graph
    */
    Instruction build() throws IOException, VerificationException {
...
//System.out.println("Used "+(used2-used)+" For "+method);
//System.out.println("BuiltFor "+method);
   ...
   /**
    * Append an instruction, or list of instrucrions, to the list
    ...
    */
    void appendPush(Instruction inst) throws IOException, VerificationException {
        push(append(inst));
    }
    ...
    */
    Instruction readInstructions() throws IOException, VerificationException {
        ...
        if (!method.isStatic()) {
            ...
            while (superType != Type.UNIVERSE) {
                ...
                if (superMethod.isFinal()) {
                    throw in.verificationException(VE_FINAL_METHOD_OVERRIDE);
                }
        ...
        while (!in.atEof()) {
            ...
            */
            if (flow == false && (code < opc_branchtarget)) { // code < opc_branchtarget/exceptiontarget/handlerstart/end,
                throw in.verificationException(VE_SEQ_BAD_TYPE);
            }
    ...
    */
    void op_error() throws IOException, VerificationException {
        throw in.verificationException(VE_BAD_INSTR);
    }
    ...
    */
    void op_wide(int code) throws IOException, VerificationException {
        switch (code) {
    ...
    */
    void op_iinc(int slot, int value) throws IOException, VerificationException {
    ...
    * Nop - do nothing
    */
    void op_nop() throws IOException, VerificationException {
    }

   /**
    * Pop item from stack,
    */
    void op_pop() throws IOException, VerificationException {
        popCategory1();
    }
    ...
    * Pop two words
    */
    void op_pop2() throws IOException, VerificationException {
    ...
    * Duplicate a word
    */
    void op_dup() throws IOException, VerificationException {
    ...
    */
    void op_dup2() throws IOException, VerificationException {
    ...
    * Duplicate ...
    */
    void op_dup_x1() throws IOException, VerificationException {
        Instruction x1 = popForDupCategory1();
        Instruction x2 = popForDupCategory1();
        pushForDup(x1);
        pushForDup(x2);
    ...
    * Duplicate ...
    */
    void op_dup_x2() throws IOException, VerificationException {
        Instruction x1 = popForDupCategory1();
    ...
    * Duplicate ...
    */
    void op_dup2_x1() throws IOException, VerificationException {
        Instruction x1 = popForDupCategory1or2();
        if(x1.isTwoWords()) {
            Instruction x2 = popForDupCategory1();
            pushForDup(x1);
    ...
    * Duplicate ...
    */
    void op_dup2_x2() throws IOException, VerificationException {
        Instruction x1 = popForDupCategory1or2();
        if(x1.isTwoWords()) {
            Instruction x2 = popForDupCategory1or2();
            if(x2.isTwoWords()) {
    ...
    * Swap top two words
    */
    void op_swap() throws IOException, VerificationException {
        Instruction x1 = popForDupCategory1();
        Instruction x2 = popForDupCategory1();
        pushForDup(x1);
        pushForDup(x2);
    ...
    */
    void op_constant(Instruction inst) throws IOException, VerificationException {
        appendPush(inst);
    }
    ...
    *
    */
    void op_load(Type basicType, int javacIndex) throws IOException, VerificationException {
    ...
    *
    */
    void op_loadAbsolute(Type basicType, int javacIndex) throws IOException, VerificationException {
    ...
    *
    */
    void op_store(Type basicType, int javacIndex) throws IOException, VerificationException {
        assume(oneIfStatic == (method.isStatic() ? 1 : 0));
    ...
    */
    void op_aload(Type type) throws IOException, VerificationException {
        ...
        if (type == Type.BYTE_ARRAY) {
            ...
            */
            ...
            if (array.type() != Type.BYTE_ARRAY && array.type() != Type.BOOLEAN_ARRAY) {
                throw in.verificationException(VE_BALOAD_BAD_TYPE);
            }
        } else {
            array = pop(type);
        }
    ...
    */
    void op_astore(Type type) throws IOException, VerificationException {
        ...
        } else if (array.type() == Type.NULLOBJECT || value.type().vIsAssignableTo(array.type().elementType())) {
            /* Success */
        } else {
            throw in.verificationException(VE_AASTORE_BAD_TYPE);
        }
        append(StoreIndexed.create(array, index, value));
    }
    ...
    */
    void op_arithmetic(Type type, int op) throws IOException, VerificationException {
    ...
    */
    void op_compare(Type type, int op) throws IOException, VerificationException {
        Instruction p2 = pop(type);
        Instruction p1 = pop(type);
    ...
    */
    void op_shift(Type type, int op) throws IOException, VerificationException {
    ...
    */
    void op_negate(Type type) throws IOException, VerificationException {
        Instruction p1 = pop(type);
    ...
    */
    void op_convert(Type typeFrom, Type typeTo, int op) throws IOException, VerificationException {
    ...
    */
    void op_if(Type type, int op, Target target) throws IOException, VerificationException {
        if (type == Type.OBJECT) {
    ...
    */
    void op_ifcmp(Type type, int op, Target target) throws IOException, VerificationException {
        Instruction p2 = pop(type);
        Instruction p1 = pop(type);
        Instruction result = checkJump(IfOp.create(op, p1, p2, target));
        append(result);
    ...
    */
    void op_goto(Target target) throws IOException, VerificationException {
    ...
    */
    void op_tableswitch() throws IOException, VerificationException {
    ...
    */
    void op_lookupswitch() throws IOException, VerificationException {
        ...
        for (int i = 0 ; i < npairs ; i++) {
            ...
            Target target = checkTarget(in.readTarget4());
            if (match < lastMatch) {
                throw in.verificationException(VE_BAD_LOOKUPSWITCH);
            }
    ...
    */
    void op_instanceof(Type type) throws IOException, VerificationException {
        Instruction p1 = pop(Type.OBJECT);
        appendPush(InstanceOf.create(type, p1));
    }

   /**
    * Allocate a checkcast instruction
    */
    void op_checkcast(Type type) throws IOException, VerificationException {
        Instruction p1 = pop(Type.OBJECT);
        appendPush(CheckCast.create(type, p1));
    }

   /**
    * Allocate a monitorenter instruction
    */
    void op_monitorenter() throws IOException, VerificationException {
        Instruction p1 = pop(Type.OBJECT);
        append(MonitorEnter.create(p1));
    }

   /**
    * Allocate a monitorexit instruction
    */
    void op_monitorexit() throws IOException, VerificationException {
        Instruction p1 = pop(Type.OBJECT);
        append(MonitorExit.create(p1));
    }
    ...
    */
    void op_initializeClass(Type type) throws IOException, VerificationException {
        // need to test if type is loaded because isAssignableTo fails with proxy types
        if (type.isLoaded() && method.parent().vIsAssignableTo(type) && !type.isInterface()) {
            return;
        }
    ...
    * Allocate initialize class instruction
    */
    void op_initializeClassPrim(Type type) throws IOException, VerificationException {
        append(InitializeClass.create(type));
    }
    ...
    */
    void op_new(Type type) throws IOException, VerificationException {
        op_initializeClass(type);
        appendPush(NewObject.create(type));
    }

   /**
    * Allocate a newarray instruction
    */
    void op_newarray(Type type) throws IOException, VerificationException {
        Instruction size = pop(Type.INT);
        appendPush(NewArray.create(type, size));
    }

   /**
    * Allocate an anewarray instruction
    */
    void op_anewarray(Type type) throws IOException, VerificationException {
        Instruction size = pop(Type.INT);
        appendPush(NewArray.create(type.asArray(), size));
    }

   /**
    * Allocate a multianewarray instruction
    */
    void op_multianewarray(Type type, int dims) throws IOException, VerificationException {
        if (dims == 0 || dims > type.dimensions()) {
            throw in.verificationException(VE_MULTIANEWARRAY, "dims="+dims+" type="+type.dimensions());
        }
    ...
    */
    void op_arraylength() throws IOException, VerificationException {
        Instruction array = pop(Type.OBJECT);
        if (array.type() != Type.NULLOBJECT && !array.type().isArray()) {
            throw in.verificationException(VE_EXPECT_ARRAY);
        }
    ...
    * Getstatic
    */
    void op_getstatic(Field field) throws IOException, VerificationException {
        op_initializeClass(field.parent());
        appendPush(LoadField.create(field, null));          // push value
    }

   /**
    * Putstatic
    */
    void op_putstatic(Field field) throws IOException, VerificationException {
        op_initializeClass(field.parent());
        append(StoreField.create(field, null, pop(field.type())));  // pop value
    }

   /**
    * Getfield
    */
    void op_getfield(Field field) throws IOException, VerificationException {
        Instruction ref;
    ...
    * Putfield
    */
    void op_putfield(Field field) throws IOException, VerificationException {
    ...
    * Invoke virtual
    */
    void op_invokevirtual(Method callee) throws IOException, VerificationException {
        if (callee.name().charAt(0) == '<') {
            throw in.verificationException(VE_EXPECT_INVOKESPECIAL);
        }
        op_invoke(callee, null, false, true);
    }

   /**
    * Invoke interface
    */
    void op_invokeinterface(Method callee, int garbage) throws IOException, VerificationException {
    ...
    * Invoke special
    */
    void op_invokespecial(Method callee) throws IOException, VerificationException {
        if (callee.name().charAt(0) == '<') {
           /*
            * Setup the receiver type to INITOBJECT if this is an <init> method
            */
            if (callee.name().equals("<init>")) {
                renameInitTo(method.parent());
            } else {
                throw in.verificationException(VE_EXPECT_INVOKESPECIAL);
            }
            op_invoke(callee, null, true, false);
        } else {
           /*
            * This is not a call to <init> so the callee must be somewhere
            * in superclass hierarchy
            */
            if (!method.parent().vIsAssignableTo(callee.parent())) {
                throw in.verificationException(VE_INVOKESPECIAL);
            }
            op_invoke(callee, null, false, false);
        }
    }
    ...
    * Invoke static
    */
    void op_invokestatic(Method callee) throws IOException, VerificationException {
        if (callee.name().charAt(0) == '<') {
            throw in.verificationException(VE_EXPECT_INVOKESPECIAL);
        }
        op_initializeClass(callee.parent());
        op_invoke(callee, append(LoadConstant.createType(callee.parent())), false, false);
    }

   /**
    * Invoke
    */
    void op_invoke(Method callee, Instruction staticNull, boolean isInvokeInit, boolean isVirtual) throws IOException, VerificationException {
        ...
        if (isInvokeStatic) {
                ...
                if (receiver instanceof NewObject) {
                    ...
                    */
                    if (receiver.type() != method.parent() && receiver.type() != method.parent().superType()) {
                        throw in.verificationException(VE_BAD_INIT_CALL);
                    }
                }
            }
            ...
            */
            if (!receiver.type().vIsAssignableTo(receiverType)) {
                ...
                throw in.verificationException(VE_STACK_BAD_TYPE, msg);
            }
        }
        ...
        */
        if (callee.type() == Type.VOID) {
            append(Invoke.create(callee, parms, isVirtual));
        } else {
            appendPush(Invoke.create(callee, parms, isVirtual));
        }
    }
    ...
    */
    void op_return() throws IOException, VerificationException {
        if (method.type() != Type.VOID) {
            throw in.verificationException(VE_EXPECT_RETVAL);
        }
        if (receiverIsUninitalizedNew()) {
            throw in.verificationException(VE_RETURN_UNINIT_THIS);
        }
    ...
    */
    void op_return(Type type) throws IOException, VerificationException {
        ...
        setControlFlow(false);
        append(Return.create(inst));
    }

   /**
    * Allocate a throw instruction
    */
    void op_athrow() throws IOException, VerificationException {
        Instruction inst = pop(Type.THROWABLE);
        setControlFlow(false);
        append(Throw.create(inst));
    }

   /**
    * Allocate a branch target instruction
    */
    void op_branchtarget(Target target) throws IOException, VerificationException {
        ...
        if (target.isExceptionTarget()) {
            throw in.verificationException("Branchtarget is also exception target" );
        }
...
//prtn("jsp="+jsp+" target= "+target.getSP());
        ...
        if (jsp != target.getSP()) {
            ...
            */
            if (jsp != target.getSP()+1) {
                throw in.verificationException("Phi stack difference > 1" );
            }
            ...
            */
            ...
            assume(prev instanceof Goto, "prev="+prev+" jsp="+jsp+" targetsp="+target.getSP());
            ...
            */
            for (int i = 1 ; i < phiParameters.length ; i++) {
                ...
                if (parm1.type().vIsAssignableTo(widest)) {
                    ...
                    throw in.verificationException("Phi type mismatch" );
                }
    ...
    */
    void op_exceptiontarget(Target target) throws IOException, VerificationException {
        if (jsp != 0 || target.getSP() != 1 || !target.isExceptionTarget()) {
            throw in.verificationException("Bad exception target stack" );
        }
    ...
    * Allocate an exception target instruction
    */
    void op_handlerstart(Target target) throws IOException, VerificationException {
    ...
    * Allocate an exception target instruction
    */
    void op_handlerend(Target target) throws IOException, VerificationException {
        Target last = null;
        ...
        throw in.verificationException("Missing handler end");
    }
    ...
    * habdlers
    */
    void checkExceptionMaps() throws IOException, VerificationException {
        Target next = currentHandlers;
        while (next != null) {
   ...
   /*
    * The following is set to false where is no direct control
...
//prtn("type["+i+"] = "+parms[i]);
    ...
    */
    void printMethodInfo() {
        in.trace("\n\n========================================================\n");
        in.trace(    "               "+method.name()+"     s="+maxStack+" l="+locals.length);
    ...
    * @param free TRUE of the instruction's local should be freed
    * @return the same instruction on popped from the stack
    */
    Instruction pop(Type type, boolean free) throws IOException, VerificationException {
        assume(type != null);
        assume(jsp > 0);
       ...
       /*
        * This local that was assigned to this instruction must be a
        * TemporaryLocal because no optomisationhas yet taken place. One
    ...
    * @return the same instruction on popped from the stack
    */
    Instruction pop(Type type) throws IOException, VerificationException {
    ...
    * @return the same instruction on popped from the stack
    */
    Instruction popForDup(Type type) throws IOException, VerificationException {
    ...
    */
    Instruction checkJump(Goto gotoinst) throws IOException, VerificationException {
    ...
    */
    void checkBranchTarget(Target target) throws IOException, VerificationException {
    ...
    */
    void checkHandlerTarget(Target target) throws IOException, VerificationException {
    ...
    */
    Target checkTarget(Target target) throws IOException, VerificationException {
...
*/
    ...
    */
    void matchStackMap(Target target, boolean replaceWithTarget, int throwCode) throws IOException, VerificationException {
        ...
        */
        if (mapLocals.length > locals.length) {
            throw in.verificationException(throwCode);
        }
        ...
        */
        for (i = 0 ; i < mapLocals.length ; i++) {
            ...
            if (currentFlow && !locals[i].vIsAssignableTo(mapLocal)) {
                throw in.verificationException(throwCode, ""+locals[i]+" not assignable to "+mapLocal);
            }
        ...
        */
        for (i = 0 ; i < mapStack.length ; i++) {
            ...
            if (currentFlow && !stack[i].type().vIsAssignableTo(mapStk)) {
                throw in.verificationException(throwCode,  ""+stack[i].type()+" not assignable to "+mapStk);
            }
    ...
    */
    void matchStackMapLocals(Target target, int throwCode) throws IOException, VerificationException {
    ...
    */
    void checkNewObject(int targetIP, int currentIP) throws IOException, VerificationException {
        if (targetIP < currentIP) {
            for (int i = 0; i < locals.length; i++) {
                if (locals[i] == Type.NEWOBJECT) {
                    throw in.verificationException(VE_BACK_BRANCH_UNINIT);
                }
            }
            for (int i = 0; i < jsp; i++) {
    ...
    Instruction popCategory1() throws IOException, VerificationException {
        return pop(Type.UNIVERSE); //temp
    }

    Instruction popCategory2() throws IOException, VerificationException {
        return pop(Type.UNIVERSE); //temp
    }

    Instruction popForDupCategory1() throws IOException, VerificationException {
        return popForDup(Type.UNIVERSE); //temp
    }

    Instruction popForDupCategory1or2() throws IOException, VerificationException {
        return popForDup(Type.UNIVERSE); //temp
    }
    ...
    */
    void setLocal(Type actualType, int javacIndex) {
    ...
    */
    Type getLocal(Type basicType, int javacIndex) throws IOException, VerificationException {
        assume(javacIndex >= 0 && javacIndex < locals.length, "locals="+locals.length+" javacIndex="+javacIndex);
        Type result = locals[javacIndex];
//prtn("        Slot["+ javacIndex+"]="+result+" basicType="+basicType);
        if (!result.vIsAssignableTo(basicType)) {
            throw in.verificationException(VE_LOCALS_BAD_TYPE);
        }
        if (basicType.isLong()) {
    ...
    */
    void freeTemporaryLocal(TemporaryLocal tempLocal) {
        if (tempLocal.decrementReferenceCount()) {
           ...
           /*
            * Add a drop local hint for the register allocater
            */
          //  append(DropLocal.create(tempLocal));
