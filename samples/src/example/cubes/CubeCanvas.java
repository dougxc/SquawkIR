...
public class CubeCanvas extends Canvas implements Runnable {
    ...
    // timing
    private long clear_cost;
    private long tmp_cost;
    private long poly_cost;
    private long blit_cost;
    private long render_cost;
    private long animation_cost;
    ...
    public void paint(Graphics graphics) {
        ...
        clear_cost = System.currentTimeMillis();
        if (draw) {
            graphics.setColor(ColorTable.black);
            graphics.fillRect(0, 0, Display.WIDTH, Display.HEIGHT);
        }
        clear_cost = System.currentTimeMillis() - clear_cost;

        render_cost = System.currentTimeMillis();
        poly_count = 0;
        ...
        for (n=0; n<objectList.length; n++) {
            ...
            for (i=0; i<object.polyList.length; i++) {
                ...
                tmp_cost = System.currentTimeMillis();
                if (draw) {
                    graphics.setColor(poly.color);
                    graphics.fillPolygon(x, y, poly.vertexList.length);
                }
                poly_cost += (System.currentTimeMillis() - tmp_cost);
                poly_count++;
            }
        }

        render_cost = System.currentTimeMillis() - render_cost;
        ...
        blit_cost = System.currentTimeMillis();
        blit_cost = System.currentTimeMillis() - blit_cost;
    ...
    public void run() {
        ...
        last_total = System.currentTimeMillis();
        frames = 0;

        for (;;) {
            total_cost = System.currentTimeMillis() - last_total;
            last_total = System.currentTimeMillis();
...
camera_yaw_step = 0;
            ...
            animation_cost = System.currentTimeMillis() - last_total;
