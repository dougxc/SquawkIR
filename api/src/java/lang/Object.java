...
public class Object {
    ...
    public native static void prt(String str);
    public native static void prtn(String str);
...
/*
    ...
    private static Class classClass = new Class();
    ...
    public final native Class getClass0();
